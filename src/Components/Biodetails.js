...
import { Link } from 'react-router-dom'
import InformationComp from './BloodBioComponents/InformationComp'
import NutritionsCompo from './BloodBioComponents/NutritionsCompo'
import SymptomsComp from './BloodBioComponents/SymptomsComp'
...
export default function Biodetails() {
    ...
    const [activeBio, setActiveBio] = useState('NutritionsCompo')
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-id="14">
                                                ...
                                                <td className="detail"><Link to="/"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="28" fill="currentColor" className="bioarw" viewBox="0 0 16 16">
                                                    <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z" />
                                                </svg></Link></td>
                                            </tr>
                                            <tr data-id="15">
                                ...
                                <div className='information-card'>
                                    <div className='inf-card rounded-2'>
                                        ...
                                        <div className='tabswitch'>
                                            <div className='tabs d-flex jusstify-center mb-4'>
                                                {/* <button className={activeBio === 'NutritionsComp' ? 'activeBio inf-ntr' : 'inf-ntr'} onClick{()=> SetactiveBio("NutritionsComp")}>Nutritions</button> */}
                                                <button className={activeBio ==='NutritionsCompo' ? 'activeBio inf-ntr' :'inf-ntr'} 
                                                onClick={() => setActiveBio("NutritionsCompo") }
                                                >Nutritions</button>
                                                <button className={activeBio ==='InformationComp' ? 'activeBio inf-ntr' :'inf-ntr'} onClick={() => setActiveBio("InformationComp")}>Information</button>
                                                <button className={activeBio ==='SymptomsComp' ? 'activeBio inf-ntr' :'inf-ntr'} onClick={() => setActiveBio("SymptomsComp")}>Symptoms</button>
                                                {/* <button className='inf-sym'>Symptoms</button>
                                                <button className='inf'>Information</button> */}
                                            </div>
                                            {activeBio === "NutritionsCompo" && <NutritionsCompo/>}
                                            {activeBio === "SymptomsComp" && <SymptomsComp/>}
                                            {activeBio === "InformationComp" && <InformationComp/>}
                                        </div>
